...
async function getRandomImage(keyword, count){
    return new Promise(function(resolve, reject){
        ...
        let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=ve9KiH-1WG4tY5oKrsLA-kQ5vfJq1tRaJkShWCoFx58&featured=true&orientation=landscape&query=${keyword}`;
